...
export default async function SignatureAppPage() {
  ...
  const [organizationResult, subscriptionResult, usageResult, envelopesResult] =
    await Promise.all([
      ...
      supabase
        ...
        .select("documents_used, certificates_used, ai_generations_used, extrajudicial_notifications_used")
        .eq("organization_id", membership.organization_id)
  ...
  return (
    <SignatureDashboardClient
      ...
      usage={usageResult.data || { documents_used: 0, certificates_used: 0, ai_generations_used: 0, extrajudicial_notifications_used: 0 }}
