  ...
  return [
    {
      ...
      cards: [
        ...
        {
          title: "Escritórios Enterprise",
          value: "Gerenciar",
          href: "/dashboard/admin/escritorios",
          icon: Building,
        ...
        {
          title: "Pesquisas da plataforma",
          value: "Gerenciar",
          href: "/dashboard/admin/pesquisas",
          icon: Star,
          tone: ADMIN_CARD_TONES.gold,
        },
      ],
      ...
      cards: [
        {
          ...
          value: "Disparar alerta",
          href: "/dashboard/admin/push",
          icon: Megaphone,
          tone: ADMIN_CARD_TONES.blue,
        },
        {
      ...
      cards: [
        {
          ...
          href: "/dashboard/admin/casos",
          icon: FileText,
        },
        {
          title: "Gestão financeira",
          value: "Ver vendas",
          href: "/dashboard/admin/transacoes",
          icon: DollarSign,
          tone: ADMIN_CARD_TONES.green,
        },
        {
          title: "Anunciantes de serviços",
          value: "Gerenciar",
          href: "/dashboard/admin/anunciantes",
          icon: Megaphone,
          tone: ADMIN_CARD_TONES.purple,
        },
        {
          title: "Gestão de afiliados",
          value: "Ver indicações",
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          value: "Ver métricas e conversões",
          href: "/dashboard/admin/casos?tab=FUNNEL",
          icon: Mail,
          tone: ADMIN_CARD_TONES.gold,
        },
      ],
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          value: "Gerenciar popup",
          href: "/dashboard/admin/advogado-mes",
          icon: Star,
          tone: ADMIN_CARD_TONES.gold,
        },
        {
        ...
        },
        {
          ...
          icon: Trash2,
          tone: ADMIN_CARD_TONES.red,
        },
        {
          title: "Radar Jurídico",
          value:
            radarPending > 0
              ? `${radarPending} pendente${radarPending !== 1 ? "s" : ""}`
              : "Sem pendências",
