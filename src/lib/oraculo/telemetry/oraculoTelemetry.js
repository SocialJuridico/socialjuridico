...
export const ORACULO_EVENTS = {
  ...
  LEGAL_LIBRARY_SEARCH: "LEGAL_LIBRARY_SEARCH",
  LEGAL_UNIT_VIEWED: "LEGAL_UNIT_VIEWED",
  LEGAL_SOURCE_ADDED: "LEGAL_SOURCE_ADDED",
  LEGAL_SOURCE_REMOVED: "LEGAL_SOURCE_REMOVED",
  LEGAL_SOURCE_SAVED: "LEGAL_SOURCE_SAVED",
  NOTEBOOK_ENTRY_CREATED: "NOTEBOOK_ENTRY_CREATED",
  NOTEBOOK_ENTRY_UPDATED: "NOTEBOOK_ENTRY_UPDATED",
  NOTEBOOK_ENTRY_ARCHIVED: "NOTEBOOK_ENTRY_ARCHIVED",
  NOTEBOOK_FICHAMENTO_CREATED: "NOTEBOOK_FICHAMENTO_CREATED",
  NOTEBOOK_FICHAMENTO_UPDATED: "NOTEBOOK_FICHAMENTO_UPDATED",
  NOTEBOOK_FICHAMENTO_COMPLETED: "NOTEBOOK_FICHAMENTO_COMPLETED",
  ACTION: "ACTION",
};
